 ...
 * Out of the box, there are {@link SocialTextView}, {@link SocialEditText}, and
 * {@code SocialAutoCompleteTextView}. It can also be implemented in any {@link android.view.View}
 * using {@link com.hanggrian.socialview.internal.SocialViews}.
 */
public interface SocialView {
     ...
     * {@link androidx.core.util.PatternsCompat#WEB_URL}.
     */
    @NonNull
    ...
    /**
     * Returns list of all <b>hashtags</b> found in {@link android.widget.TextView#getText()}.
     */
    @NonNull
    List<String> getHashtags();

    /**
     * Returns list of all <b>mentions</b> found in {@link android.widget.TextView#getText()}.
     */
    @NonNull
    List<String> getMentions();

    /**
     * Returns list of all <b>hyperlinks</b> found in {@link android.widget.TextView#getText()}.
     */
    @NonNull
