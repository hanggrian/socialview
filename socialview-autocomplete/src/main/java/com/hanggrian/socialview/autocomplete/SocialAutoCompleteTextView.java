...
import com.hanggrian.socialview.SocialView;
import com.hanggrian.socialview.internal.SocialViews;
...
public class SocialAutoCompleteTextView extends AppCompatMultiAutoCompleteTextView
    ...
    /**
     * While {@code CommaTokenizer} tracks only comma symbol, {@code CharTokenizer} can track
     * multiple characters, in this instance, are hashtag and at symbol.
     *
