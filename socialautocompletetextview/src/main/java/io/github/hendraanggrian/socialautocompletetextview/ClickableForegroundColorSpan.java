...
public final class ClickableForegroundColorSpan extends ClickableSpan {
    ...
    private final SocialAutoCompleteTextView.OnSocialClickListener listener;

    public ClickableForegroundColorSpan(@ColorInt int color, @NonNull SocialAutoCompleteTextView.OnSocialClickListener listener) {
        this.color = color;
